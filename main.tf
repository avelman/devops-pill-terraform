...
# Data Source from AWS for Availability Zones
...
resource "aws_subnet" "subnet_1" {
  provider          = aws.region-master
  availability_zone = element(data.aws_availability_zones.azs.names, 0) # element is a Function which takes the data provided earlier
  vpc_id            = aws_vpc.vpc_master.id
...
# Setup the Peering in between both VPCs
# it has to be generated and accepted
